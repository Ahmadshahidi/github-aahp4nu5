...
**Model**: $y = \beta_0 + \beta_1x_1 + \beta_2x_2 + \ldots + \beta_px_p + \epsilon$
...
**Model**: $\log\left(\frac{p}{1-p}\right) = \beta_0 + \beta_1x_1 + \ldots + \beta_px_p$
...
**Model**: $\log(\lambda) = \beta_0 + \beta_1x_1 + \ldots + \beta_px_p$
...
Adds penalty term: $\lambda\sum_{i=1}^p\beta_i^2$
...
Adds penalty term: $\lambda\sum_{i=1}^p|\beta_i|$
...
- $\alpha$ controls mix of L1 and L2 penalties
