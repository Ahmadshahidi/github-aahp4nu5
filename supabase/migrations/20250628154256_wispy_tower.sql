...
-- Create a unique constraint on customer_id for stripe_subscriptions to ensure one subscription per customer
CREATE UNIQUE INDEX IF NOT EXISTS stripe_subscriptions_customer_id_unique 
